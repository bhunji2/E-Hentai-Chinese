			...
			"<div class='optmain'>"+
				...
				"<div class='optsub'>"+
					...
					'<input type="radio" name="TRlang" value="cn" id="zh_cn">'+
						'<label for="zh_cn" id="TR_cn">简体中文</label><br>'+
				"</div>"+
			"</div>"+
...
function Pager(){
	...
	uconfig();
	/*
	$("div.ido div.id3 a img[src*='ul.ehgt.org']").each(function(){
		var src = $(this).attr("src")
		$(this).attr("src",src.replace("l.jpg","250.jpg"))
	})
	*/
	//http://ul.ehgt.org/04/cf/04cfa7d37ca57de1ae4c2178522eacb311097b53-407122-708-1000-jpg_l.jpg
};
...
function TagListChange(){
	$("#taglist td.tc").css("table-layout","fixed").css("width","50px");
